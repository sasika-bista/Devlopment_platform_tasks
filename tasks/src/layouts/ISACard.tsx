...
export const ISACard = () => {
  const files = ["HtmlTutorial.pdf", "HTMLtask.docx", "CSSBeginners.pdf"];
  return (
    <div className="border border-black/20 mt-10.25 rounded-md px-8 py-8.75 bg-white">
      <div className="flex flex-col gap-5.5">
        ...
        <div className="flex flex-col gap-1.5 items-start ml-0.25">
          <p className="text-black/80 text-[16.25px]">
          ...
          <p className="text-black/80 text-[16.25px]">
            process from requirements analysis to implementation. Learn about
            entity-relationship modeling, functional dependencies, and all
            normal
          </p>
          <p className="text-black/80 text-[16.25px]">forms.</p>
        </div>
          ...
          <div className="flex items-center gap-4 w-[673px]">
            {files.map((file) => (
              <Link
                ...
                className="w-[186.5px] px-4.5 py-2 border border-black/30 rounded-sm flex items-center gap-2 grow"
              >
