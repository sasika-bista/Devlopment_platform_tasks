...
=======
    <div className="w-full h-screen border-2 border-black">
      {/* nav bar */}
      <header className="border-b border-[#68686833] pl-23.5 pr-20 pt-4.5 pb-5">
        <nav className=" flex justify-between items-center ">
          <img src={hckCoreLogo} alt="HCK Core LOGO" width={"67px"} />
          <button
            type="button"
            className="bg-[#75BF43] hover:bg-[#A4C93A] text-[16px] font-medium rounded-lg  w-28.25 p-2  text-white cursor-pointer "
          >
>>>>>>> Stashed changes
            Login
            </button>
